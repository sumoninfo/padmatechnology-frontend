  ...
  <div class="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
      ...
      <div class="shadow-outline rounded px-8 pt-6 pb-8 mb-4 flex flex-col">
        <form class="mt-8 space-y-6" @submit.prevent="register()">
          ...
          <div class="mb-4">
            ...
            <input required v-model="form.email"
          ...
          <div class="mb-6">
            ...
            <input required v-model="form.password"
          ...
          <div class="mb-6">
            ...
            <input required v-model="form.password_confirmation"
                   class="shadow appearance-none border border-red rounded w-full py-2 px-3 text-grey-darker mb-3"
      ...
      <div class="text-center">
        <router-link :to="{name:'userLogin'}" class="font-medium text-indigo-600 hover:text-indigo-500">
